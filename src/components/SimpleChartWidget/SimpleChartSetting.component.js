    ...
    return (
      <BaseSetting {...this.props}>
        <div className="col-12 d-flex justify-content-center">
          <span
            className={
              configs.chartType === 'pie' ? 'chart-type active' : 'chart-type'
            }
          >
            <FaPieChart size={40} />
          </span>
          <span
            className={
              configs.chartType === 'line' ? 'chart-type active' : 'chart-type'
            }
          >
            <FaLineChart size={40} />
          </span>
          <span
            className={
              configs.chartType === 'bar' ? 'chart-type active' : 'chart-type'
            }
          >
            <FaBarChart size={40} />
          </span>
