...
class TableSetting extends React.PureComponent {
    ...
    componentWillUnmount(){
        ...
        const selectedElements = document.querySelectorAll('#right-side .column-items');
                    ...
                    <div className="row">
                        <div className="col-6">
                            ...
                            <ul id="left-side" className="columns">
                                {availableColumns.map(col => <li key={col} className="column-items">{col}</li>)}
                            </ul>
                        </div>
                        <div className="col-6">
                            <Label>Selected Columns:</Label>
                            <ul id="right-side" className="columns">
                                {configs.selectedColumns.map(col => <li key={col} className="column-items">{col}</li>)}
                            </ul>
                        </div>                   
                    </div>
                </div>
