        ...
        _createClass(Utilities, [
          ...
          },
          {
            ...
            value: function getMaxId(arr) {
              var employeeWithMaxId = arr.reduce(function(
                employeeWithMaxId,
                currentEmp
              ) {
                return currentEmp.id > employeeWithMaxId.id
                  ? currentEmp
                  : employeeWithMaxId;
              });
      ...
      var Breadcrumbs = (function() {
        ...
        _createClass(Breadcrumbs, [
            ...
            value: function getSuperiorInfo(node) {
              ...
              while (!!node && !!node.parentElement) {
                ...
                if (
                  ...
                  // get name and id
                  var name = node.parentElement.querySelector(
                    "[name='fullName']"
                  ).innerHTML;
                  superiorInfo = [
                    { id: node.parentElement.id, name: name }
                  ].concat(_toConsumableArray(superiorInfo));
                }
                node = node.parentElement;
              }
              superiorInfoList = [].concat(
                _toConsumableArray(superiorInfoList),
                _toConsumableArray(superiorInfo)
              );
          ...
          },
          {
            ...
            value: function createBreadcrumbsBySuperiorInfo(
              superiorInfo,
              displayName
            ) {
              var breadcrumbs = document.querySelector(
                "#breadcrumbs [name='breadcrumbs_container']"
              );
              ...
              for (var index in superiorInfo) {
                breadcrumbs.insertAdjacentHTML(
                  'beforeend',
                  '<li><a data-id="' +
                    superiorInfo[index].id +
                    '" class="link">' +
                    superiorInfo[index].name +
                    '</a></li>'
                );
              }
              breadcrumbs.insertAdjacentHTML(
                'beforeend',
                '<li><a class="selected">' + displayName + '</a></li>'
              );
            }
          ...
          },
          {
            ...
            value: function updateBreadcrumbs(id) {
              ...
              var name =
                node && node.querySelector("[name='fullName']").innerHTML;
          ...
          },
          {
            ...
            value: function renderBreadcrumbs(id) {
              ...
              this.createBreadcrumbsBySuperiorInfo(
                superiorInfoList,
                selectedCard.name
              );
            }
          ...
          },
          {
            ...
            value: function openDialog(id, successCallback, cancelCallback) {
              ...
              this.overlay.style.width =
                document.querySelector('body').scrollWidth + 'px';
    ...
    /***/ function(module, exports, __webpack_require__) {
      ...
      var Chart = (function() {
        function Chart() {
          ...
          this.rootEmployeeId = rootEmployeeId;
        ...
        _createClass(Chart, [
          {
            ...
            value: function parseRawEmpList(empList) {
              for (var index in empList) {
                ...
                empList[index].fullSuperiorId = !!empList[index].superiorId
                  ? idPrefix + empList[index].superiorId
                  : undefined;
                empList[index].fullName =
                  empList[index].firstName + ' ' + empList[index].lastName;
                empList[index].avatarFullPath =
                  '' + imagePath + empList[index].avatar;
              }
              return empList;
            }
          },
          ...
          },
          {
            ...
            value: function buildEmployeeTree(employeeList, elementId) {
              ...
              var rootEmployee = this.rootEmployeeId
                ? employeeList.find(function(m) {
                    return m.id === _this2.rootEmployeeId;
                  })
                : utilities.findRoot(employeeList);
              var rootElement = document.getElementById(elementId);
              rootElement.innerHTML =
                '<ul>' + this.createNode(rootEmployee) + '</ul>';
                ...
                if (!(0, _LocalStorage.isExistInStorage)('contacts')) {
                  api
                    ...
                    .then(function(rawData) {
                      currentEmpList = _this3.parseRawEmpList(
                        JSON.parse(rawData)
                      );
                  ...
                  currentEmpList = JSON.parse(
                    (0, _LocalStorage.getData)('contacts')
                  );
                  resolve(currentEmpList);
                }
              });
          ...
          },
          {
            ...
            value: function createNode(employee) {
              ...
              return (
                ...
                (!utilities.isRoot(employee)
                  ? '<i class="fas fa-trash-alt" name="delete_button"></i>'
                  : '') +
          ...
          },
          {
            ...
            value: function getEditedInfo(id) {
              var fullName = document.querySelector(
                '#' + id + " [name='info_edit'] [name='fullName']"
              ).value;
              var department = document.querySelector(
                '#' + id + " [name='info_edit'] [name='department']"
              ).value;
              var employeeId = document.querySelector(
                '#' + id + " [name='info_edit'] [name='employeeId']"
              ).value;
              var avatarFullPath = document
                .querySelector(
                  '#' + id + " [name='info_edit'] [name='avatar'] img"
                )
                .getAttribute('src');
              return {
                fullName: fullName,
          ...
          },
          {
            ...
            value: function displayEditedInfo(id, editedInfo) {
              document.querySelector(
                '#' + id + " [name='info'] [name='fullName']"
              ).innerHTML =
                editedInfo.fullName;
              document.querySelector(
                '#' + id + " [name='info'] [name='department']"
              ).innerHTML =
                editedInfo.department;
              document.querySelector(
                '#' + id + " [name='info'] [name='employeeId']"
              ).innerHTML =
                editedInfo.employeeId;
              document.querySelector(
                '#' + id + " [name='info'] [name='avatar'] img"
              ).src =
                editedInfo.avatarFullPath;
            }
          ...
          },
          {
            ...
            value: function saveEditedInfo(id, editedInfo) {
              var index = utilities.findEmployeeIndexByFullId(
                id,
                currentEmpList
              );
              if (index >= 0) {
                ...
                currentEmpList[index].avatarFullPath =
                  editedInfo.avatarFullPath;
                (0, _LocalStorage.saveData)(currentEmpList);
              }
            }
          ...
          },
          {
            ...
            value: function getAllChildIds(element) {
              ...
              if (childNodes.length) {
                for (
                  var index = 0, len = childNodes.length;
                  index < len;
                  index++
                ) {
          ...
          },
          {
            ...
            value: function getFirstLevelChilds(element) {
              ...
              if (childNodes && childNodes.children.length) {
                for (
                  var index = 0, len = childNodes.children.length;
                  index < len;
                  index++
                ) {
          ...
          },
          {
            ...
            value: function createPeerNode(selectedId) {
              var selectedNodeInfo =
                currentEmpList[
                  utilities.findEmployeeIndexByFullId(
                    selectedId,
                    currentEmpList
                  )
                ];
              ...
              document
                ...
                .insertAdjacentHTML('afterend', peerNode);
            }
          ...
          },
          {
            ...
            value: function handleClickOutSideSelectedNode() {
              ...
              document.querySelector(
                '#' + currentEditingEmpId + " [name='action']"
              ).style.display =
                'none';
          ...
          },
          {
            ...
            value: function handleClickAvatar(id) {
              if (currentEditingEmpId === id) {
                var avatarUpload = document.querySelector(
                  '#' + id + " [name='info_edit'] [name='avatar_upload']"
                );
          ...
          },
          {
            ...
            value: function handleClickCreatePeer(id) {
              var employee =
                currentEmpList[
                  utilities.findEmployeeIndexByFullId(id, currentEmpList)
                ];
          ...
          },
          {
            ...
            value: function handleClickToggle(id) {
              ...
              var expandButton = document.querySelector(
                '#' + id + " >a .toggle-tree [name='expand_button']"
              );
              var collapseButton = document.querySelector(
                '#' + id + " >a .toggle-tree [name='collapse_button']"
              );
          ...
          },
          {
            ...
            value: function handleUploadingAvatar() {
              utilities.bindEvent(
                '#tree',
                'change',
                '[name="info_edit"] [name="avatar_upload"]',
                function(e) {
            ...
            value: function handleDragAndDrop() {
              ...
              utilities.bindEvent(
                ...
                function(e) {
                  ...
                  var dragToChild = _this7
                    .getAllChildIds(dragSrcEl)
                    .includes(dropEl.id);
                  var dragToParent = _this7
                    .getFirstLevelChilds(dropEl)
                    .includes(dragSrcEl.id);
                  ...
                  if (dragSrcEl != dropEl && !dragToChild && !dragToParent) {
                    ...
                    if (firstLevelChildsOfSrcEl.length) {
                      ...
                      for (
                        var index = 0;
                        index < firstLevelChildsOfSrcEl.length;
                        index++
                      ) {
                        dragSrcEl.parentElement.appendChild(
                          document.getElementById(
                            firstLevelChildsOfSrcEl[index]
                          )
                        );
                      }
                    ...
                    if (prevParentofSrc.childElementCount < 1) {
                      prevParentofSrc.parentElement.removeChild(
                        prevParentofSrc
                      );
                    }
                    var idxSrc = utilities.findEmployeeIndexByFullId(
                      dragSrcEl.id,
                      currentEmpList
                    );
                    var idxDest = utilities.findEmployeeIndexByFullId(
                      dropEl.id,
                      currentEmpList
                    );
                    currentEmpList[idxSrc].superiorId =
                      currentEmpList[idxDest].id;
                    currentEmpList[idxSrc].fullSuperiorId =
                      currentEmpList[idxDest].fullId;
                    (0, _LocalStorage.saveData)(currentEmpList);
                  }
                }
              );
          ...
          },
          {
            ...
            value: function createActionForAllNodes() {
              ...
              breadcrumbs.callbackWhenBreadcrumbsChanged(
                this.renderTreeByRootId.bind(this)
              );
              ...
              window.onclick = function(e) {
                if (currentEditingEmpId) {
                  _this8.handleClickOutSideSelectedNode();
                  currentEditingEmpId = undefined;
                }
              };
            }
          ...
          },
          {
            ...
            value: function insertNode(node, superiorId) {
              ...
              var childNodes =
                parentNode && parentNode.getElementsByTagName('ul');
          ...
          },
          {
            ...
            value: function insertAllNodes(rootEmployeInfo) {
              var grouped =
                arguments.length > 1 && arguments[1] !== undefined
                  ? arguments[1]
                  : utilities.groupBySuperiorId(currentEmpList);
